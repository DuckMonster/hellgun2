...
set LIBS=-lopengl32.lib -lglfw3.lib -luser32.lib -llibcmtd.lib -lucrtd.lib -lvcruntimed.lib -lKernel32.lib -lGdi32.lib -lShell32.lib
set DEFINES=-DSDL_MAIN_HANDLED -DDEBUG=1
set FILES=
